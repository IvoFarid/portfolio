...
export default function Home() {
  ...
  return (
    <div className="bg-slate-200 dark:bg-zinc-900 text-dark h-screen overflow-y-scroll overflow-x-hidden z-0 scroll-smooth scrollbar-thumb-[#40474e] scrollbar-thin">
      <Head>
