...
export default function Projects({
  ...
  return (
    <motion.div 
      ...
      <h3 className="2xl:text-5xl lg:text-4xl sm:text-3xl text-2xl font-bold absolute 2xl:top-32 xl:top-[4.5rem] text-[#40474e]">{language==='english'?"Projects":'Proyectos'}</h3>
      <div className="absolute md:top-32 xl:top-[7.5rem] 2xl:top-48 grid lg:grid-cols-2 xl:grid-cols-3 gap-4 grid-flow-row px-6 pt-0 pb-5">
        {
          language==='english' ? (
